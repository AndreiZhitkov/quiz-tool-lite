...
class qtl_queries
{
	 ...
	 */
	public static function getQuestionPots($order="DESC")
	{
	
		global $wpdb;
		$table_name = $wpdb->prefix . "AI_Quiz_tblQuestionPots";		
		
		$SQL='Select * FROM '.$table_name.' ORDER by potID '.$order.'';
	...
	public static function getQuizzes($order)
	{
		global $wpdb;
	...
	public static function getQuizResults($quizID, $order="DESC")
	{
		global $wpdb;
