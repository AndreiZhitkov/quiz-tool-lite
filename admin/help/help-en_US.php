...
<div class="tab" style="float: left; width:30%;">
	...
	<h3  class="nav-tab">Overview</h3></a>
	<a onclick="openTab(event, 'started')">
	<h3 class="nav-tab">Getting stared : Creating your question pots</h3></a>
	<a onclick="openTab(event, 'questions')">
	<h3 class="nav-tab">Creating Questions</h3></a>
	<a onclick="openTab(event, 'question_feedback')">
	<h3 class="nav-tab">Question feedback</h3></a>
	<a onclick="openTab(event, 'insertQuestion')" >
	<h3 class="nav-tab">Adding questions to a page</h3></a>
	<a onclick="openTab(event, 'quiz')" >
	<h3 class="nav-tab">Creating Quizzes</h3></a>
	<a onclick="openTab(event, 'insertQuiz')">
	<h3 class="nav-tab">Adding a quiz to a page</h3></a>
	<a onclick="openTab(event, 'shortcodes')">
	<h3 class="nav-tab">Shortcodes</h3></a>
	<a onclick="openTab(event, 'showResponse')">
	<h3 class="nav-tab">Showing user responses</h3></a>
	<a onclick="openTab(event, 'results')" >
	<h3 class="nav-tab">Viewing Results</h3></a>
	<a onclick="openTab(event, 'more_help')">
	<h3 class="nav-tab">More Help</h3></a>
...
$imgSrc =  $homeURL.'/wp-content/plugins/quiz-tool-lite/admin/help/pot-example-en_US.jpg';
//echo $imgSrc;
...
<?php
$imgSrc =  $homeURL.'/wp-content/plugins/quiz-tool-lite/admin/help/question-add-en_US.jpg';
echo '<div style="text-align:center"><img src="'.$imgSrc.'" />';
